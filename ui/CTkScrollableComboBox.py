...
class CTkScrollableDropdown(customtkinter.CTkToplevel):
    ...
    def __init__(self, attach, x=None, y=None, button_color=None, height: int = 300, width: int = None,
                 ...
                 command=None, image_values=[], alpha: float = 1, frame_corner_radius=2, double_click=False,
        ...
        self.disable = False
        self.fg_color = customtkinter.ThemeManager.theme["CTkEntry"]["fg_color"] if fg_color is None else fg_color
        ...
        self.dummy_entry = customtkinter.CTkEntry(self.frame, fg_color="red", border_width=0, height=1, width=1)
